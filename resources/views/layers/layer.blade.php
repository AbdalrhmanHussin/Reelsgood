...
<body>
        ...
        <nav class="d-flex w-100 pt-2 pb-2">
            <div class="logo-container d-flex align-items-center align-items-center">
                ...
                <a href="/" class="logo">
                    ...
                    <img src="{{asset('image/logo.png')}}" class="w-100" alt="logo">
                </a>
            </div>
    ...
    <div class="rg-container">
        ...
        <footer class="d-flex align-center w-100  pt-3 pb-3">
            ...
            <ul class="navbar-nav flex-row">
                <li class="nav-item pl-2"><a href="http://www.dribble.com" target="_blank" class="links" rel="noreferrer"><ion-icon name="logo-dribbble"></ion-icon></a></li>
                <li class="nav-item pl-2"><a href="http://www.twitter.com" class="links" rel="noreferrer"><ion-icon name="logo-twitter"></ion-icon></a></li>
                <li class="nav-item pl-2"><a href="http://www.facebook.com" class="links" rel="noreferrer"><ion-icon name="logo-facebook"></ion-icon></a></li>
                <li class="nav-item pl-2"><a href="http://www.youtube.com" class="links" rel="noreferrer"><ion-icon name="logo-youtube"></ion-icon></a></li>
                <li class="nav-item pl-2"><a href="http://www.pintrest.com" class="links" rel="noreferrer"><ion-icon name="logo-pinterest"></ion-icon></a></li>
            </ul>
        </footer>
    </div>
    <script>
    ...
    <script src="{{asset('js/slides.js')}}" async></script>
    <script src="{{asset('js/menus.js')}}" async></script>
    <script src="{{asset('js/calls.js')}}" type="module" async></script>
</body>
